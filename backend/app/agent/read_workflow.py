...
BACKLOG_FORMAT_TURN = (
    ...
    "change.\n"
    "\n"
    "Exemple de FORME. N'en recopie ni les mots ni le sujet, seulement la "
    "disposition :\n"
    "| Consulter son solde | | En tant que client, je souhaite consulter mon solde, "
    "afin de savoir ce dont je dispose. | Affiche le solde du compte courant. | "
    "Etant donne que le client est connecte | Lorsque le client ouvre l'ecran "
    "d'accueil Alors son solde s'affiche | |\n"
    "| | | | | Etant donne que le solde est indisponible | Lorsque le client ouvre "
    "l'ecran d'accueil Alors un message d'indisponibilite s'affiche | |\n"
    "Deux choses a relever sur ces deux lignes. La seconde laisse les trois "
    "premieres cellules vides. Et TOUTES DEUX contiennent le mot Alors -- y compris "
    "la PREMIERE ligne du bloc, celle qui l'oublie le plus souvent parce qu'on vient "
    "d'y ecrire la userstory.\n"
    "{lignes_attendues}"
    "\n"
